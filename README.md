# Martin Galway - C64 Music
An attempt at automating simple playback of Martin Galway's classic music source files from 1980's Commodore 64 games as .prg files

## TO DO
1. revise oceans_assembler_directives.txt into 64tass-usable format
